...
function resolvePorts(args) {
  ...
  // Legacy / custom: explicit port without a named profile → single-port scan
...
export async function execute(args) {
  ...
  const advice = [
    ...
    "See examples/local-llm-providers.settings.yaml in this repo for Ollama / LM Studio / vLLM / llama-server snippets.",
  ];
